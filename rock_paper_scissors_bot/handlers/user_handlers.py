...
from MyProjects.rock_paper_scissors_bot.keyboards.keyboards import game_kb, yes_no_kb
from MyProjects.rock_paper_scissors_bot.lexicon.lexicon import LEXICON
from MyProjects.rock_paper_scissors_bot.services.services import get_bot_choice, get_winner
